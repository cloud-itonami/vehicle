...
// ../cljs/src/vehicle/app.kotoba); backend TypeScript was to be left alone. It
...
//     documented thin edge dispatcher Worker — does not call
//     `env.ASSETS.fetch()`, so it cannot be substituted as `main` without
//     something else serving the assets).
//
